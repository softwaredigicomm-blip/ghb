...
export function getPrescriptionPrintHtml(
  ...
  return `
    ...
    <html>
      <head>
        ...
        <style>
          ...
          .container {
            ...
            padding-top: ${actualTemplateImage ? '240px' : '0px'};
          }
          .header {
            text-align: center;
            padding-bottom: 12px;
            display: ${actualTemplateImage ? 'none' : 'block'};
          }
          .hosp-name {
            font-size: 28px;
            font-weight: 800;
      ...
      <body>
        <div class="container">
          ${actualTemplateImage ? `<div class="template-bg"><img src="${actualTemplateImage}" style="width: 100%;" /></div>` : ''}
          <div class="header">
